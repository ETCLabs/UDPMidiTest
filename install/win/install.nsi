...
!define PRODUCT_NAME "ETC UDP Midi Test"
!define EXE_NAME "UdpMidiTest"
...
Please log in as an administrator to install StreamingMIDI."
	quit
isAdmin:
...
;close the opened previously uninstall log macros block.
	...
	CreateShortcut '$SMPROGRAMS\${PRODUCT_NAME}\${EXE_NAME}.lnk' '$INSTDIR\${EXE_NAME}.exe'
